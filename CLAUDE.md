# GAIA-BT v3.43 - 신약개발 AI 연구 어시스턴트
...
- **v3.34**: 응답 다이어로그 줄바꿈 및 띄어쓰기 완전 개선 - 자연스러운 텍스트 표시
- **v3.35**: 마크다운 리스트 렌더링 완전 개선 - * 기호 인식 및 중첩 들여쓰기 정확 처리
- **v3.36**: CSS 및 컴포넌트 최적화로 리스트 줄바꿈 문제 완전 해결
- **v3.37**: 마크다운 리스트 전후 줄바꿈 완전 보장 - 텍스트와 리스트 간 자연스러운 간격 구현
